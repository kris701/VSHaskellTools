...
namespace HaskellRunner
{
    ...
    [Guid(HaskellToolsOptionsPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    [ProvideOptionPage(typeof(OptionPageGrid),
    "Haskell Tools", "Options", 0, 0, true)]
    public sealed class HaskellToolsOptionsPackage : AsyncPackage
    {
        #region Settings
        ...
        /// <summary>
        /// HaskellToolsOptionsPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "c8ee89a0-6b81-4d68-ba91-8299cbbd60d6";

        /// <summary>
        /// Initializes a new instance of the <see cref="HaskellToolsOptionsPackage"/> class.
        /// </summary>
        public HaskellToolsOptionsPackage()
        {
